...
parser.add_argument('--show-auc', dest='show_auc', action='store_true',
                   default=False,
                   help='print the roc_auc of the results. (default: False)')
