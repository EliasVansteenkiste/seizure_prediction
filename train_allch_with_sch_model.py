...
if args.no_training:
	netSpec = model_evaluation(1,magnitude_window,ceil-floor,batch_iterator_train=batch_iterators.BI_train_sch(16),batch_iterator_test=batch_iterators.BI_test_sch(16))
else:
	netSpec = model_training(1,magnitude_window,ceil-floor,batch_iterator_train=batch_iterators.BI_train_sch(16),batch_iterator_test=batch_iterators.BI_test_sch(16))	
